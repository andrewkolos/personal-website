...
type cUsersAndrewDesktoppersonalWebsitesrccomponentsaboutMeaboutMeTsx3433321874QueryVariables = Exact<{ [key: string]: never; }>;


type cUsersAndrewDesktoppersonalWebsitesrccomponentsaboutMeaboutMeTsx3433321874Query = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }> };
