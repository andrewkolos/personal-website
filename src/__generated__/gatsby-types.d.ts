...
enum GRVSCCodeBlockFieldsEnum {
  ...
  language = 'language',
  meta = 'meta',
  defaultTheme___path = 'defaultTheme.path',
  defaultTheme___identifier = 'defaultTheme.identifier',
  defaultTheme___conditions = 'defaultTheme.conditions',
  defaultTheme___conditions___condition = 'defaultTheme.conditions.condition',
  defaultTheme___conditions___value = 'defaultTheme.conditions.value',
  additionalThemes = 'additionalThemes',
  additionalThemes___path = 'additionalThemes.path',
  additionalThemes___identifier = 'additionalThemes.identifier',
  additionalThemes___conditions = 'additionalThemes.conditions',
  additionalThemes___conditions___condition = 'additionalThemes.conditions.condition',
  additionalThemes___conditions___value = 'additionalThemes.conditions.value',
  tokenizedLines = 'tokenizedLines',
  tokenizedLines___tokens = 'tokenizedLines.tokens',
  tokenizedLines___tokens___text = 'tokenizedLines.tokens.text',
  tokenizedLines___tokens___startIndex = 'tokenizedLines.tokens.startIndex',
  tokenizedLines___tokens___endIndex = 'tokenizedLines.tokens.endIndex',
  tokenizedLines___tokens___scopes = 'tokenizedLines.tokens.scopes',
  tokenizedLines___tokens___html = 'tokenizedLines.tokens.html',
  tokenizedLines___tokens___className = 'tokenizedLines.tokens.className',
  tokenizedLines___tokens___defaultThemeTokenData___themeIdentifier = 'tokenizedLines.tokens.defaultThemeTokenData.themeIdentifier',
  tokenizedLines___tokens___defaultThemeTokenData___className = 'tokenizedLines.tokens.defaultThemeTokenData.className',
  tokenizedLines___tokens___defaultThemeTokenData___meta = 'tokenizedLines.tokens.defaultThemeTokenData.meta',
  tokenizedLines___tokens___defaultThemeTokenData___color = 'tokenizedLines.tokens.defaultThemeTokenData.color',
  tokenizedLines___tokens___defaultThemeTokenData___bold = 'tokenizedLines.tokens.defaultThemeTokenData.bold',
  tokenizedLines___tokens___defaultThemeTokenData___italic = 'tokenizedLines.tokens.defaultThemeTokenData.italic',
  tokenizedLines___tokens___defaultThemeTokenData___underline = 'tokenizedLines.tokens.defaultThemeTokenData.underline',
  tokenizedLines___tokens___additionalThemeTokenData = 'tokenizedLines.tokens.additionalThemeTokenData',
  tokenizedLines___tokens___additionalThemeTokenData___themeIdentifier = 'tokenizedLines.tokens.additionalThemeTokenData.themeIdentifier',
  tokenizedLines___tokens___additionalThemeTokenData___className = 'tokenizedLines.tokens.additionalThemeTokenData.className',
  tokenizedLines___tokens___additionalThemeTokenData___meta = 'tokenizedLines.tokens.additionalThemeTokenData.meta',
  tokenizedLines___tokens___additionalThemeTokenData___color = 'tokenizedLines.tokens.additionalThemeTokenData.color',
  tokenizedLines___tokens___additionalThemeTokenData___bold = 'tokenizedLines.tokens.additionalThemeTokenData.bold',
  tokenizedLines___tokens___additionalThemeTokenData___italic = 'tokenizedLines.tokens.additionalThemeTokenData.italic',
  tokenizedLines___tokens___additionalThemeTokenData___underline = 'tokenizedLines.tokens.additionalThemeTokenData.underline',
  tokenizedLines___gutterCells = 'tokenizedLines.gutterCells',
  tokenizedLines___gutterCells___className = 'tokenizedLines.gutterCells.className',
  tokenizedLines___gutterCells___text = 'tokenizedLines.gutterCells.text',
  tokenizedLines___text = 'tokenizedLines.text',
  tokenizedLines___html = 'tokenizedLines.html',
  tokenizedLines___attrs = 'tokenizedLines.attrs',
  tokenizedLines___className = 'tokenizedLines.className',
  tokenizedLines___data = 'tokenizedLines.data',
  tokenizedLines___isHighlighted = 'tokenizedLines.isHighlighted',
  tokenizedLines___lineNumber = 'tokenizedLines.lineNumber',
  tokenizedLines___diff = 'tokenizedLines.diff',
  id = 'id',
  parent___id = 'parent.id',
  parent___parent___id = 'parent.parent.id',
  parent___parent___parent___id = 'parent.parent.parent.id',
...
enum GRVSCCodeSpanFieldsEnum {
  ...
  additionalThemes___conditions___value = 'additionalThemes.conditions.value',
  tokens = 'tokens',
  tokens___text = 'tokens.text',
  tokens___startIndex = 'tokens.startIndex',
  tokens___endIndex = 'tokens.endIndex',
  tokens___scopes = 'tokens.scopes',
  tokens___html = 'tokens.html',
  tokens___className = 'tokens.className',
  tokens___defaultThemeTokenData___themeIdentifier = 'tokens.defaultThemeTokenData.themeIdentifier',
  tokens___defaultThemeTokenData___className = 'tokens.defaultThemeTokenData.className',
  tokens___defaultThemeTokenData___meta = 'tokens.defaultThemeTokenData.meta',
  tokens___defaultThemeTokenData___color = 'tokens.defaultThemeTokenData.color',
  tokens___defaultThemeTokenData___bold = 'tokens.defaultThemeTokenData.bold',
  tokens___defaultThemeTokenData___italic = 'tokens.defaultThemeTokenData.italic',
  tokens___defaultThemeTokenData___underline = 'tokens.defaultThemeTokenData.underline',
  tokens___additionalThemeTokenData = 'tokens.additionalThemeTokenData',
  tokens___additionalThemeTokenData___themeIdentifier = 'tokens.additionalThemeTokenData.themeIdentifier',
  tokens___additionalThemeTokenData___className = 'tokens.additionalThemeTokenData.className',
  tokens___additionalThemeTokenData___meta = 'tokens.additionalThemeTokenData.meta',
  tokens___additionalThemeTokenData___color = 'tokens.additionalThemeTokenData.color',
  tokens___additionalThemeTokenData___bold = 'tokens.additionalThemeTokenData.bold',
  tokens___additionalThemeTokenData___italic = 'tokens.additionalThemeTokenData.italic',
  tokens___additionalThemeTokenData___underline = 'tokens.additionalThemeTokenData.underline',
  id = 'id',
  parent___id = 'parent.id',
  parent___parent___id = 'parent.parent.id',
  parent___parent___parent___id = 'parent.parent.parent.id',
...
type SitePageContext = {
  readonly slug: Maybe<Scalars['String']>;
  readonly myLibraries: Maybe<ReadonlyArray<Maybe<SitePageContextMyLibraries>>>;
  readonly other: Maybe<ReadonlyArray<Maybe<SitePageContextOther>>>;
  readonly contributedTo: Maybe<ReadonlyArray<Maybe<SitePageContextContributedTo>>>;
};

type SitePageContextContributedTo = {
...
type SitePageContextContributedToFilterListInput = {
  readonly elemMatch: Maybe<SitePageContextContributedToFilterInput>;
};

type SitePageContextFilterInput = {
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly myLibraries: Maybe<SitePageContextMyLibrariesFilterListInput>;
  readonly other: Maybe<SitePageContextOtherFilterListInput>;
  readonly contributedTo: Maybe<SitePageContextContributedToFilterListInput>;
};

type SitePageContextMyLibraries = {
  readonly name: Maybe<Scalars['String']>;
  readonly owner: Maybe<Scalars['String']>;
  readonly url: Maybe<Scalars['String']>;
  readonly description: Maybe<Scalars['String']>;
...
type SitePageContextMyLibrariesFilterListInput = {
  readonly elemMatch: Maybe<SitePageContextMyLibrariesFilterInput>;
};

type SitePageContextOther = {
  readonly name: Maybe<Scalars['String']>;
  readonly owner: Maybe<Scalars['String']>;
  readonly url: Maybe<Scalars['String']>;
  readonly description: Maybe<Scalars['String']>;
...
type SitePageContextOtherFilterListInput = {
  readonly elemMatch: Maybe<SitePageContextOtherFilterInput>;
};
...
enum SitePageFieldsEnum {
  ...
  context___myLibraries___name = 'context.myLibraries.name',
  context___myLibraries___owner = 'context.myLibraries.owner',
  context___myLibraries___url = 'context.myLibraries.url',
  context___myLibraries___description = 'context.myLibraries.description',
  context___myLibraries___createdAt = 'context.myLibraries.createdAt',
  context___myLibraries___updatedAt = 'context.myLibraries.updatedAt',
  context___other = 'context.other',
  context___other___name = 'context.other.name',
  context___other___owner = 'context.other.owner',
  context___other___url = 'context.other.url',
  context___other___description = 'context.other.description',
  context___other___createdAt = 'context.other.createdAt',
  context___other___updatedAt = 'context.other.updatedAt',
  context___contributedTo = 'context.contributedTo',
  context___contributedTo___name = 'context.contributedTo.name',
  context___contributedTo___owner = 'context.contributedTo.owner',
  context___contributedTo___url = 'context.contributedTo.url',
  context___contributedTo___description = 'context.contributedTo.description',
  context___contributedTo___createdAt = 'context.contributedTo.createdAt',
  context___contributedTo___updatedAt = 'context.contributedTo.updatedAt',
  ...
  pluginCreator___pluginOptions___colorTheme = 'pluginCreator.pluginOptions.colorTheme',
  pluginCreator___pluginOptions___injectStyles = 'pluginCreator.pluginOptions.injectStyles',
  pluginCreator___pluginOptions___extensionDataDirectory = 'pluginCreator.pluginOptions.extensionDataDirectory',
  pluginCreator___pluginOptions___logLevel = 'pluginCreator.pluginOptions.logLevel',
  ...
  pluginCreator___pluginOptions___emitPluginDocuments___src___generated___gatsby_plugin_docments_graphql = 'pluginCreator.pluginOptions.emitPluginDocuments.src___generated___gatsby_plugin_docments_graphql',
...
enum SitePluginFieldsEnum {
  ...
  pluginOptions___plugins___pluginOptions___colorTheme = 'pluginOptions.plugins.pluginOptions.colorTheme',
  pluginOptions___plugins___pluginOptions___injectStyles = 'pluginOptions.plugins.pluginOptions.injectStyles',
  pluginOptions___plugins___pluginOptions___extensionDataDirectory = 'pluginOptions.plugins.pluginOptions.extensionDataDirectory',
  pluginOptions___plugins___pluginOptions___logLevel = 'pluginOptions.plugins.pluginOptions.logLevel',
  ...
  pluginOptions___colorTheme = 'pluginOptions.colorTheme',
  pluginOptions___injectStyles = 'pluginOptions.injectStyles',
  pluginOptions___extensionDataDirectory = 'pluginOptions.extensionDataDirectory',
  pluginOptions___logLevel = 'pluginOptions.logLevel',
  ...
  pluginOptions___emitPluginDocuments___src___generated___gatsby_plugin_docments_graphql = 'pluginOptions.emitPluginDocuments.src___generated___gatsby_plugin_docments_graphql',
...
type SitePluginPluginOptions = {
  ...
  readonly logLevel: Maybe<Scalars['String']>;
...
type SitePluginPluginOptionsEmitPluginDocuments = {
  readonly src___generated___gatsby_plugin_docments_graphql: Maybe<Scalars['Boolean']>;
};

type SitePluginPluginOptionsEmitPluginDocumentsFilterInput = {
  readonly src___generated___gatsby_plugin_docments_graphql: Maybe<BooleanQueryOperatorInput>;
};
...
type SitePluginPluginOptionsFilterInput = {
  ...
  readonly logLevel: Maybe<StringQueryOperatorInput>;
...
type cUsersAndrewDesktoppersonalWebsitesrccomponentsblogblogTemplateTsx364240779QueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type cUsersAndrewDesktoppersonalWebsitesrccomponentsblogblogTemplateTsx364240779Query = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'html'>
    & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'slug' | 'title' | 'subtitle'>> }
  )> };

type cUsersAndrewDesktoppersonalWebsitesrcpagesindexTsx3813167167QueryVariables = Exact<{ [key: string]: never; }>;


type cUsersAndrewDesktoppersonalWebsitesrcpagesindexTsx3813167167Query = { readonly allMarkdownRemark: (
...
type cUsersAndrewDesktoppersonalWebsitesrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;
...
type cUsersAndrewDesktoppersonalWebsitesrccomponentsblogblogListblogListTsx3128776230QueryVariables = Exact<{ [key: string]: never; }>;


type cUsersAndrewDesktoppersonalWebsitesrccomponentsblogblogListblogListTsx3128776230Query = { readonly allMarkdownRemark: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'id' | 'excerpt'>
        & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'subtitle' | 'date' | 'slug'>> }
      ) }> }
  ) };
